...
import ru.ejik_land.audiostories.utils.MediaIDHelper;
import ru.ejik_land.audiostories.utils.QueueHelper;

import static ru.ejik_land.audiostories.utils.MediaIDHelper.MEDIA_ID_MUSICS_BY_ALBUM;
import static ru.ejik_land.audiostories.utils.MediaIDHelper.MEDIA_ID_ROOT;
import static ru.ejik_land.audiostories.utils.MediaIDHelper.createBrowseCategoryMediaID;
import static ru.ejik_land.audiostories.utils.MediaIDHelper.extractBrowseCategoryFromMediaID;
...
//                                "com.verbery.android.mediabrowserservice/drawable/ic_by_genre"))
...
//        } else if (MEDIA_ID_MUSICS_BY_ALBUM.equals(parentMediaId)) {
            ...
            String album = extractBrowseCategoryFromMediaID(parentMediaId)[1];
            ...
            for (MediaMetadata track: mMusicProvider.getMusicsByAlbum(album)) {
                ...
                // on where the music was selected from (by artist, by genre, random, etc)
                String hierarchyAwareMediaID = MediaIDHelper.createTrackMediaID(
                        MEDIA_ID_MUSICS_BY_ALBUM, album, track);
                MediaMetadata trackCopy = new MediaMetadata.Builder(track)
                        .putString(MediaMetadata.METADATA_KEY_MEDIA_ID, hierarchyAwareMediaID)
                        .build();
    ...
    private final class MediaSessionCallback extends MediaSession.Callback {
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            mSession.setQueue(mPlayingQueue);
            String queueTitle = getString(R.string.browse_musics_by_album_subtitle,
