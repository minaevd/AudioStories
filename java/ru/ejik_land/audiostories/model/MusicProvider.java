...
public class MusicProvider {
    ...
    private final HashMap<String, List<MediaMetadata>> mMusicListByAlbum;
...
//                        mMusicListByGenre.put(genre, list);
                        ...
                        // put album
                        String album = item.getString(MediaMetadata.METADATA_KEY_ALBUM);
                        List<MediaMetadata> list = mMusicListByAlbum.get(album);
                        if (list == null) {
                            list = new ArrayList<>();
                        }
                        list.add(item);
